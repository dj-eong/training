...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2024-04-01T19:55:59.594167" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/ora2pg-243-have-been-released-2832/">Ora2Pg 24.3 have been released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-04-01 by HexaCluster</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgmoneta-010-2831/">pgmoneta 0.10</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-04-01 by pgmoneta</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/remembering-simon-riggs-2830/">Remembering Simon Riggs</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-03-27 by PostgreSQL Core Team</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6su"> Talk: Postgres Yum Extensions</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Wheeler</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-04-01</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6st"> Exploring versions of the Postgres logical replication protocol</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6ss"> PostgreSQL clustering solutions</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6sq"> PG Day Chicago – the talks I am most excited about (part I)</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Henrietta Dombrovskaya</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-29</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6sr"> PDXPUG April Meeting: What’s new in PostgreSQL 17</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6sp"> PG Phriday: A Dirty Postgres Rag</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6so"> Procedure To Multiple Client Certificate Feature</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-28</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6sn"> PGXN v2: Go or Rust?</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Wheeler</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-28</li>
            </ul>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6sm"> Build HNSW 80% Faster with Parallel Index Build in pgvector</a></h3>
            <ul class="meta">
