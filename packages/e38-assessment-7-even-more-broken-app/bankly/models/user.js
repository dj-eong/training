...
class User {
	...
	static async authenticate(username, password) {
		...
		if (user) {
			...
			throw new ExpressError('Invalid username', 401);
		}
	}
	...
	static async update(username, data) {
		// FIXES BUG #5
		if (Object.keys(data).includes('admin') || Object.keys(data).includes('password') || Object.keys(data).includes('username')) {
			throw new ExpressError('Not allowed to change this info', 401);
		}
